...
<html>
<head>
    <title>SLOT TIME TABLE - JOTHI GANESH(212224240065)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - JOTHI GANESH (212224240065) </strong></p>
    </div>
    <table>
        <tr>
...
## OUTPUT
![alt text](<Screenshot 2025-05-23 181921.png>)
